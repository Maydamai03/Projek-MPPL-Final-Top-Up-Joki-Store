...
<head>
    ...
    position: relative; /* Penting untuk posisi relative */
    }
...
<body>
    ...
    <div class="container" style="display: flex; gap: 20px;">
     ...
     <h5 class="offcanvas-title" id="offcanvasExampleLabel" style="margin-left: 20px; margin-top: 8px; font-family: Poppins;font-size: 30px;">D'Mond Store</h5>
            </div>
    <br>
    ...
    <form action="login.php" method="post">
            <div class="mb-3">
                ...
                <br>
                <button style="border-radius: 50px;width: 500px;height: 57px;margin-bottom: 30px; background-color: rgb(238, 107, 245);color: white; border-style: none;" class="btn " type="submit " name="submitform" >LOGIN</button>
            </form>
