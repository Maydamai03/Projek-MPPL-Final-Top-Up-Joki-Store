            ...
            <div class="formright" style="margin-left: 50px;font-family:Poppins; font-size:13px; padding:8px;">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td> <a href="https://id-id.facebook.com/login/device-based/regular/login/?login_attempt=1" style="margin-left: 10px;margin-bottom: 10px; color: rgb(255, 255, 255);text-decoration:none;">D'Mond Store</a></td>
                    </tr>
                    <tr>
                        ...
                        <td> <a href="https://www.instagram.com/accounts/login/" style="margin-left: 10px;margin-bottom: 10px;color: rgb(255, 255, 255);text-decoration:none;">D'Mond Store</a></td>
                    </tr>
                    <tr>
                        ...
                        <td> <a href="https://twitter.com/i/flow/login?input_flow_data=%7B%22requested_variant%22%3A%22eyJsYW5nIjoiaWQifQ%3D%3D%22%7D" style="margin-left: 10px;margin-bottom: 10px;color: rgb(255, 255, 255);text-decoration:none;">D'Mond Store.com</a></td>
                    </tr>
                </table>
            </div>
        </div>
